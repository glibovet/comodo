			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
					...
					<div class="catalog__sorting">
						<button type="button" class="catalog__view-btn1"></button>
						<button type="button" class="catalog__view-btn2"></button>
						<div class="catalog__sorting-price">
							<span>Цена</span>
							<select>
								<option value="по возростанию">по возростанию</option>
								<option value="По убиванию">по убиванию</option>
								<option value="По рейтингу">по рейтингу</option>
							</select>
						</div>
						<div class="catalog__sorting-view">
							<span>Вид</span>
							<select>
						...
						<div class="catalog__page">
							...
							<button type="button" class="catalog__prev-page"></button>
					...
					<div class="catalog__inner three-column">
							...
							<a href="#">
								...
								<div class="catalog__descr">
									...
									<div class="catalog__descr-param">
										<p class="catalog__descr-name">Спальня</p>
										<p class="catalog__descr-value">daytona</p>
									</div>
									<div class="catalog__descr-param">
										<p class="catalog__descr-name">Фабрика</p>
										<p class="catalog__descr-value">SIGNORINI-COCO&amp; C.s.n.r.</p>
									</div>
								</div>
							</a>
						</div>
...
<!-- 					<div class="catalog__inner two-column">
						<div class="catalog__item">
							<a href="#">
								<img src="img/new3.jpg" alt="alt">
								<div class="catalog__descr">
