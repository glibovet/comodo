  	...
  	<div id="login-input">
        ...
        <div id="login-input-cont">
            ...
            <div id="login-input-log">
            	<input id="login_login" type="text" placeholder="Email" autocomplete="off" value="" onfocus="$('#login-input-log').css('background','#3f4856');" onblur="$('#login-input-log').css('background','none');">
            </div>
            
            <div id="login-input-pass">
            	<input id="login_pass" type="password" placeholder="Пароль" autocomplete="off" value="" onfocus="$('#login-input-pass').css('background','#3f4856');" onblur="$('#login-input-pass').css('background','none');">
            </div>
            </form>
