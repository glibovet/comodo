<?php 
	...
	$itemsList = $zh->getContacts($params);

	$totalItems = $zh->getContacts($params,true);
	...
	$filter2_options = array( 
							...
							'Город'		=> array( 'fieldName'=>'M.city', 'params' => $catsListFilter ),
							);
							
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Городу'=>'city' ),
	...
	$tableColumns = array(
						  ...
						  'Город'		=>	array( 'type'=>'text', 		'field'=>'city'),	 
						  'Адрес'		=>	array( 'type'=>'text', 	'field'=>'adress'),
						  'Телефон'		=>	array( 'type'=>'text', 	'field'=>'phone_number'),
