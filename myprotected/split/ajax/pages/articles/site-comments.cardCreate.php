<?php 
	...
	$cardTmp = array(
					...
					//'Выбор файлов'			=>	array( 'type'=>'image_mult','field'=>'images', 		'params'=>array( 'path'=>"/webroot/img/split/files/users/", 'appTable'=>$appTable, 'id'=>$item_id, 'field'=>'file', 'method'=>'create' ) )
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"createSiteComment", 'ajaxFolder'=>'create', 'appTable'=>$appTable );
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>Форма создания отзыва о сайте".((isset($params['copyItem']) && $params['copyItem'] > 0) ? "(Дубликат карточки #".$params['copyItem'].")" : "")."</h3>";
