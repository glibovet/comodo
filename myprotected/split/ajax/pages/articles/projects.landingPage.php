<?php 
	...
	//echo "<pre>"; print_r($usersList); echo "</pre>";  exit();
	...
	{
		$catsListFilter[$user['fname']]=$user['id'];
	}
	...
	$filter2_options = array( 
							...
							'Архитектор'		=> array( 'fieldName'=>'M.user_name', 'params' => $catsListFilter ),
							);
							
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Заголовку'=>'name', 'Архитектор'=>'user_name' ),
	...
	$tableColumns = array(
						  ...
						  'Заголовок материала'	=>	array('type'=>'text',		'field'=>'name'),
						  'Архитектор'			=>	array('type'=>'text',		'field'=>'user_name'),
