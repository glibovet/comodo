<?php 
	...
	$itemsList = $zh->getSiteMessages($params);

	$totalItems = $zh->getSiteMessages($params,true);
	...
	$filter2_options = array( 
							'Публикация' => array( 'fieldName'=>'M.dateCreate') 
							);
							
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Name'=>'name', 'Публикации'=>'dateCreate' ),
	...
	$tableColumns = array(
						  ...
						  'ID пользователя'		=>	array('type'=>'text',		'field'=>'user_id'),
