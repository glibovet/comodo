<?php 
	...
	$cardTmp = array(
					 ...
					 'Содержание '.$lpx		=>	array( 'type'=>'redactor', 	'field'=>$pref.'data', 	'params'=>array(  ) ),
					 ...
					 /*'Изображение (MOB)'			=>	array( 'type'=>'header'),
					 
					 'Изображение материала (min: 1366x768px)'=>	array( 'type'=>'image_mono', 'field'=>'file_sm', 		'params'=>array( 'path'=>"/webroot/img/split/files/content/", 'appTable'=>$appTable, 'id'=>$item_id ) ),*/
