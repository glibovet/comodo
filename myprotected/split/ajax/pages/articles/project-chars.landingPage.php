<?php 
	...
	$itemsList = $zh->getProjectChars($params);

	$totalItems = $zh->getProjectChars($params,true);
	...
	$charGroupsFilter = array();
	foreach($charGroups as $item)
	{
		$charGroupsFilter[$item['name']]=$item['id'];
	}
	...
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Name'=>'name', 'Group'=>'group_name' ),
