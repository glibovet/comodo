<?php 
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"createShopCharsItem", 'ajaxFolder'=>'create', 'appTable'=>$appTable );
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>Форма создания товарного свойства</h3>";
