<?php 
	...
	$itemsList = $zh->getProdCol($params);

	$totalItems = $zh->getProdCol($params,true);
	...
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Название'=>'name' ),
	...
	$tableColumns = array(
						  ...
						  'Название (UA)'		=>	array('type'=>'text',		'field'=>'ua_name'),
						  'Название (EN)'		=>	array('type'=>'text',		'field'=>'en_name'),
