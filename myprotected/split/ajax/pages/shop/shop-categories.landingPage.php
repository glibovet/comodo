<?php 
	...
	/*$parentsList		= $zh->getCatalogParents();
	
	// Prepare arrays for filter
	
	$parentsListFilter = array();
	foreach($parentsList as $parentItem)
	{
		$parentsListFilter[$parentItem['name']]=$parentItem['id'];
	}
	*/
	...
	$filter2_options = array( 
							...
							'Категория' => array( 'fieldName'=>'M.parent', 'params' => $catalogList, 'type'=>'allCatalog', 'top_include'=>true )
							);
							
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Позиции'=>'M.pos', 'Названию'=>'name', 'Родительской категории'=>'parent' , 'Создателю'=>'M.adminMod'),
	...
	$tableColumns = array(
						  ...
						  'Родитель'		=>	array('type'=>'parent',		'field'=>'parent_name'),
						  'Позиция'			=>	array('type'=>'update_cat_pos',		'field'=>'pos'),
