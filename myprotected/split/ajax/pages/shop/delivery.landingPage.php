<?php 
	...
	$itemsList = $zh->getShopDeliveryMeth($params);

	$totalItems = $zh->getShopDeliveryMeth($params,true);
	...
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Название'=>'name', 'Цена'=>'price' ),
	...
	$tableColumns = array(
						  ...
						  'Цена'				=>	array('type'=>'number',		'field'=>'price'),
