<?php 
	...
	$cardTmp = array(
					 ...
					 'Страна '.$lpx			=>	array( 'type'=>'input', 	'field'=>$pref.'country', 		'params'=>array( 'size'=>50, 'hold'=>'country' ) ),
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editShopMfItem", 'ajaxFolder'=>'edit', 'appTable'=>$appTable, 'lpx'=>$lpx, 'headParams'=>$headParams, 'langs'=>$langs );
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>Форма редактирования производителя <b>&laquo;".strtoupper($cardItem['name'])."&raquo;</b></h3>";
