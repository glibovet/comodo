<?php 
	...
	$dinChars 	= $_POST['dinChars']; 
				
	//echo "<pre>"; print_r($dinChars); echo "</pre>"; exit();
	
	$dinCharsSerialize = (is_array($dinChars) ? serialize($dinChars) : serialize(array()));
	...
	if($orderMass && $productMass)
	{
		...
		$cartItem = array(
						  ...
						  'session_id' 		=> 0,
						  'prod_id' 		=> $pid,
						  'dinamic_chars'	=> $dinCharsSerialize,
						  'quant' 	   		=> $quant,
						  'char_id'			=> $char_ref_id,
