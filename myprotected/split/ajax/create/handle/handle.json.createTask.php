				...
				if($item_id)
				{
					...
					if($RespUser)
					{
						...
						$r_mess = "<p>".$R['name']." ".$R['fname'].", Вы получили новое задание от администратора.</p>
								   ...
								   <p>Перейдиете в админпанель для выполнения: <a href='http://itfurline.com/myprotected'>Перейти</a></p>
						...
						$ah->wp_send_letter($R['login'],"support@itfurline.com","New ItFurLine Task: ".$cardUpd['subject'],$r_mess);
					}
