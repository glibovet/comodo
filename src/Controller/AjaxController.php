		...
		{				
			...
			{	
				...
				INSERT INTO osc_shop_orders  
											(client_email, client_phone, client_name, type, author_id, user_id, status, paid_status, pay_method, delivery_method, delivery_address, details, products, dateCreate, dateModify) 
						 			VALUES 
