    ...
    public function index()
    {
		...
		$saleList =  $conn->query("
					SELECT C.*, 
						...
						(SELECT id FROM osc_shop_like WHERE `session_id` = '".SESID."' AND `uid` = '".UID."' AND `prod_id` = C.prod_id LIMIT 1) as prod_like,
						...
						FROM osc_shop_prod_group_ref as C
						WHERE C.group_id = '2'
						ORDER BY id DESC
					")->fetchAll('assoc');
				$this->set("saleList", $saleList);// Список товаров в расспродаже;t
