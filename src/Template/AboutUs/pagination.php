<ul>
	...
	<?php
        ...
        {
            ?>
            <li><a href="javascript:void(0);" onClick="goCatalogPage(1);">1</a></li>
            ...
            ?>
            <li><a class="pageCounterNum" href="javascript:void(0);" onClick="goCatalogPage(1);">1</a></li>
            <li><a class="pageCounterNum" href="javascript:void(0);" onClick="goCatalogPage(<?php echo ($f_page_num-1) ?>);">...</a></li>
            <?php
...
<?php if ($f_page_num < $f_pages_count){?> 
	<button type="button" onClick="goCatalogPage(<?=$f_page_num+1?>);"><?php $i=0; foreach ($site_translate as $translate){					
                                            if ($translate['ru_text'] == "Далее") {
                                                $i++;
                                                if ($i==1 ) {
                                                    echo $translate['text'];
                                                    }
